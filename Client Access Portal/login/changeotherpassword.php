...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vH">
        <form class="border shadow p-3 rounded" action="../php/check-changeotherpassword.php" method="post" style="width: 800px;" id="signup">
            <h1 name="myForm" class="text-center p-3">CAMBIAR CONTRASEÑA DE OTRO USUARIO</h1>
            ...
            <?php } ?>
            <div class="mb-3">
                <input type="username" class="form-control" name="username" id="username" placeholder="Username" aria-label="Username" required>
            </div>
            <div class="mb-3">
