...
<body>
    <div class="login-box">
        <div class="box-root flex-flex flex-direction--column">
            ...
            <br><br>
            <button onclick="location.href='./login/login.php'" type="button" style="z-index: 10" class="btn mt-4">INICIAR SESION</button>
            <br><br>
            <button onclick="location.href='./login/proof.php'" type="button" style="z-index: 10" class="btn mt-4">¡EN ABIERTO!</button>
            <br>
