...
const getGames = async (req, res) => {
    const [result] = await pool.query('SELECT game.game_id, competition.competition_abbreviation, competition.competition_season, fixture.fixture_number, game.game_localteam, game.game_localgoals, game.game_visitantgoals, game.game_glentered, game.game_gventered, game.game_visitantteam FROM game JOIN fixture ON game.game_fixture=fixture.fixture_id JOIN competition ON fixture.fixture_competition=competition.competition_id JOIN team_competition ON team_competition.competition=competition.competition_id WHERE competition.competition_abbreviation="' + req.query.competition + '" AND competition.competition_season="' + req.query.season + '" GROUP BY game.game_id')
